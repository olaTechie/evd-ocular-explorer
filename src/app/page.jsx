    ...
    <div className="container">
          ...
          <div className="stat-grid">
            {summary.headline.map((h) => (
              <div key={h.outcome} className="card stat">
                <div className="big"><CountUp value={h.pct} /></div>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="banner">
          Every figure here derives from the <strong>source-verified dataset</strong>. Estimates are pooled prevalence
          in <em>examined survivors</em> and carry substantial heterogeneity — read the CI and I², and use{" "}
